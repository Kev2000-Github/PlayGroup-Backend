const Room = require("../../../database/models/RoomTicTacToe");

export const createRoom = async (roomId: string, { uuid, turn, nickname }, grid: Array<number>) => {
...
export const updateGrid = async (roomId: string, grid: Array<number>) => {
